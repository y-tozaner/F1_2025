...
axs[0].plot (ver_tel['Distance'], ver_vCar, color='#0055ffff')
axs[0].plot (lec_tel['Distance'], lec_vCar, color='#E21B4D')
axs[0].set_ylabel('Speed (km/h)')
axs[1].plot(ver_tel['Distance'], ver_nCar, color='#0055ffff')
axs[1].plot(lec_tel['Distance'], lec_nCar, color='#E21B4D')
axs[1].set_ylabel('RPM')
axs[2].plot (ver_tel['Distance'], ver_nGear, color='#0055ffff')
axs[2].plot (lec_tel['Distance'], ham_nGear, color='#E21B4D')
